 ...
 * 
 * Class Merchant
 * @param _id - identification of the Merchant (number)
 * @param _name - name of the Merchant (string)
 * @param _type - type of job of the Merchant (string)
 * @param _location - place of origin of Merchant (string)
 */
